# Развёртывание с Caddy (все в Docker)

> **Примечание:** Если у вас Caddy уже работает на отдельном контейнере (например, в Proxmox), см. [DEPLOYMENT_PRODUCTION.md](DEPLOYMENT_PRODUCTION.md) для инструкций по развёртыванию в такой конфигурации.

## Архитектура с Caddy (все в Docker)
